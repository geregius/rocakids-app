...
| `acudiente_portal_screen.dart` | "Mis hijos" — accesible por CUALQUIER cuenta logueada. Si el usuario no tiene perfil de acudiente todavía, se lo pide ahí mismo (sin crear cuenta nueva). Si ya lo tiene, muestra la lista de niños + botón "Agregar hijo". |
