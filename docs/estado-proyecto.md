...
⚠️ **Los niños registrados ANTES del 2026-08-14 no tienen documento en esta colección** (se empezó a escribir recién con esta feature) — no van a aparecer en la búsqueda por nombre, solo por documento manual, hasta que se haga un respaldo puntual o se editen. **Importante para el Módulo 2 (migración de datos):** el script de importación masiva debe escribir también en `ninos_busqueda`, no solo en `ninos`, o toda la migración quedará invisible para esta búsqueda.
